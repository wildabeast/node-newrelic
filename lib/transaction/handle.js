...
module.exports.Stub = class TransactionHandleStub {
    ...
    console.log('No transaction found when calling Transaction.end')
  }

  ignore() {
    console.log('No transaction found when calling Transaction.ignore')
  }

  isSampled() {
    console.log('No transaction found when calling Transaction.isSampled')
  }

  acceptDistributedTraceHeaders() {
    console.log('No transaction found when calling Transaction.acceptDistributedTraceHeaders')
  }

  insertDistributedTraceHeaders() {
    console.log('No transaction found when calling Transaction.insertDistributedTraceHeaders')
  }
}
